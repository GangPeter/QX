...
async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd-live-rain.json`
...
function rraUrl() {
    let url = 'https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd-live-rain.json'
