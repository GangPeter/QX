...
* @ScriptURL         https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd_cash_exchange.js
* ==/UserScript==
【QuantumultX】 :
*************************
[task_local]
0,1,2 0 * * * https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd_cash_exchange.js, tag=领现金兑换红包
*************************
【Loon】 :
*************************
[Script]
cron "0,1,2 0 * * *" script-path=https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd_cash_exchange.js,tag=领现金兑换红包
*************************
【Surge】 :
*************************
[Script]
领现金兑换红包 = type=cron,cronexp="0,1,2 0 * * *",wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd_cash_exchange.js
*************************
【小火箭】 :
*************************
[Script]
领现金兑换红包 = type=cron,script-path=https://raw.githubusercontent.com/GangPeter/QX/main/Jd/jd_cash_exchange.js, cronexpr="0,1,2 0 * * *", timeout=500, enable=true
*************************
[mitm]
